...
- [Jarmos-san/graphql-server](https://github.com/Jarmos-san/graphql-server) - The simplest GraphQL server to test your MVP on a local machine (3 days ago)
...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.79.1](https://github.com/tiangolo/fastapi/releases/tag/0.79.1), 2 days ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
