...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.75.2](https://github.com/tiangolo/fastapi/releases/tag/0.75.2), 2 days ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
...
- [developersIndia/jarvim](https://github.com/developersIndia/jarvim) ([v0.1.0](https://github.com/developersIndia/jarvim/releases/tag/v0.1.0), 3 weeks ago) - A sensible IDE-like configuration for Neovim
