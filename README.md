...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.78.0](https://github.com/tiangolo/fastapi/releases/tag/0.78.0), 3 weeks ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
...
- [An Automated &amp; Modern Workflow for Using LaTex](https://jarmosan.hashnode.dev/an-automated-and-modern-latex-workflow) (2 days ago)
