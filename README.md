...
- [Jarmos-san/jefer](https://github.com/Jarmos-san/jefer) - A simple, intuitive &amp; cross-platform tool to manage your dotfiles (4 days ago)
...
- [Jarmos-san/resume](https://github.com/Jarmos-san/resume) - My public resume created using Typst! (1 week ago)
...
- [litestar-org/litestar](https://github.com/litestar-org/litestar) ([v2.0.0beta1](https://github.com/litestar-org/litestar/releases/tag/v2.0.0beta1), 3 days ago) - Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs
- [Jarmos-san/resume](https://github.com/Jarmos-san/resume) ([v0.0.1](https://github.com/Jarmos-san/resume/releases/tag/v0.0.1), 1 week ago) - My public resume created using Typst!
...
- [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ([v1.4.3](https://github.com/folke/which-key.nvim/releases/tag/v1.4.3), 4 weeks ago) - 💥   Create key bindings that stick. WhichKey is a lua plugin for Neovim 0.5 that displays a popup with possible keybindings of the command you started typing.
