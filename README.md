...
- [Jarmos-san/neovim-docker](https://github.com/Jarmos-san/neovim-docker) ([v1.2.1](https://github.com/Jarmos-san/neovim-docker/releases/tag/v1.2.1), 2 days ago) - My containerised Neovim configurations written in Lua
- [dnephin/pre-commit-golang](https://github.com/dnephin/pre-commit-golang) ([v0.5.1](https://github.com/dnephin/pre-commit-golang/releases/tag/v0.5.1), 4 days ago) - Golang hooks for pre-commit
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.85.0](https://github.com/tiangolo/fastapi/releases/tag/0.85.0), 3 weeks ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
