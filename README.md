...
- [Jarmos-san/resume](https://github.com/Jarmos-san/resume) - My public resume created using Typst! (3 weeks ago)
...
- [litestar-org/litestar](https://github.com/litestar-org/litestar) ([v2.0.0beta2](https://github.com/litestar-org/litestar/releases/tag/v2.0.0beta2), 1 week ago) - Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs
- [Jarmos-san/resume](https://github.com/Jarmos-san/resume) ([v0.0.1](https://github.com/Jarmos-san/resume/releases/tag/v0.0.1), 3 weeks ago) - My public resume created using Typst!
