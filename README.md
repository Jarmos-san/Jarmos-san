...
- [Jarmos-san/nextjs-project-template](https://github.com/Jarmos-san/nextjs-project-template) - A template repository for using with Next.js projects (2 weeks ago)
...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.75.0](https://github.com/tiangolo/fastapi/releases/tag/0.75.0), 2 days ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
