...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.82.0](https://github.com/tiangolo/fastapi/releases/tag/0.82.0), 5 days ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
- [Jarmos-san/vale-precommit](https://github.com/Jarmos-san/vale-precommit) ([v0.1.0](https://github.com/Jarmos-san/vale-precommit/releases/tag/v0.1.0), 2 weeks ago) - A Pre-Commit hook to lint Markdown &amp; Text files for grammatical/spelling errors
...
- [Should You Use Next.js?](https://jarmosan.hashnode.dev/should-you-use-nextjs) (4 weeks ago)
