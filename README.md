...
- [starlite-api/starlite](https://github.com/starlite-api/starlite) - Light, Flexible and Extensible ASGI API framework (4 days ago)
...
- [starlite-api/starlite](https://github.com/starlite-api/starlite) ([v1.48.1](https://github.com/starlite-api/starlite/releases/tag/v1.48.1), 4 days ago) - Light, Flexible and Extensible ASGI API framework
