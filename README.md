...
- [Jarmos-san/nextjs-project-template](https://github.com/Jarmos-san/nextjs-project-template) - A template repository for using with Next.js projects (4 days ago)
- [developersIndia/wiki](https://github.com/developersIndia/wiki) - The Developers India Wiki for some cool resources (4 days ago)
...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.74.0](https://github.com/tiangolo/fastapi/releases/tag/0.74.0), 3 days ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
