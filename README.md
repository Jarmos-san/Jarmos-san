...
- [Jarmos-san/neovimulus](https://github.com/Jarmos-san/neovimulus) - A sanely minimal configuration framework for Neovim enthusiasts! (1 day ago)
- [Weburz/commitlint-config](https://github.com/Weburz/commitlint-config) - A repository containing the commit rules for all projects built at Weburz (3 days ago)
...
- [litestar-org/litestar](https://github.com/litestar-org/litestar) ([v2.2.1](https://github.com/litestar-org/litestar/releases/tag/v2.2.1), 3 days ago) - Production-ready, Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs
