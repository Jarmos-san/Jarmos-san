...
- [Weburz/commitlint-config](https://github.com/Weburz/commitlint-config) - A repository containing the commit rules for all projects built at Weburz (2 days ago)
...
- [litestar-org/litestar](https://github.com/litestar-org/litestar) ([v2.2.1](https://github.com/litestar-org/litestar/releases/tag/v2.2.1), 2 days ago) - Production-ready, Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs
...
- [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ([v1.5.1](https://github.com/folke/which-key.nvim/releases/tag/v1.5.1), 3 months ago) - 💥   Create key bindings that stick. WhichKey is a lua plugin for Neovim 0.5 that displays a popup with possible keybindings of the command you started typing.
