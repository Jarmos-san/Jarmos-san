...
- [Jarmos-san/neovimulus](https://github.com/Jarmos-san/neovimulus) - A sanely minimal configuration framework for Neovim enthusiasts! (2 days ago)
...
- [Jarmos-san/neovimulus](https://github.com/Jarmos-san/neovimulus) ([v2.0.0](https://github.com/Jarmos-san/neovimulus/releases/tag/v2.0.0), 2 days ago) - A sanely minimal configuration framework for Neovim enthusiasts!
- [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ([v1.4.1](https://github.com/folke/which-key.nvim/releases/tag/v1.4.1), 4 days ago) - 💥   Create key bindings that stick. WhichKey is a lua plugin for Neovim 0.5 that displays a popup with possible keybindings of the command you started typing.
- [litestar-org/litestar](https://github.com/litestar-org/litestar) ([v1.51.12](https://github.com/litestar-org/litestar/releases/tag/v1.51.12), 6 days ago) - Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs
