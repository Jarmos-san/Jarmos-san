...
- [Jarmos-san/setup-vercel](https://github.com/Jarmos-san/setup-vercel) - A GitHub Action for deploying to Vercel (1 day ago)
...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.75.1](https://github.com/tiangolo/fastapi/releases/tag/0.75.1), 5 days ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
