...
- [Jarmos-san/resets.css](https://github.com/Jarmos-san/resets.css) - An unopinionated and minimal CSS resets script for maximum cross-browser compatability! (6 days ago)
...
- [Jarmos-san/homelab](https://github.com/Jarmos-san/homelab) - 🧪 The repository containing management resources for my homelab (1 month ago)
...
- [litestar-org/litestar](https://github.com/litestar-org/litestar) ([v2.4.2](https://github.com/litestar-org/litestar/releases/tag/v2.4.2), 2 days ago) - Production-ready, Light, Flexible and Extensible ASGI API framework | Effortlessly Build Performant APIs
