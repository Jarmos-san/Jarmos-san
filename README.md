...
- [developersIndia/jarvim](https://github.com/developersIndia/jarvim) ([v0.1.0](https://github.com/developersIndia/jarvim/releases/tag/v0.1.0), 1 day ago) - A sensible IDE-like configuration for Neovim
- [Jarmos-san/shellcheck-precommit](https://github.com/Jarmos-san/shellcheck-precommit) ([v0.1.0](https://github.com/Jarmos-san/shellcheck-precommit/releases/tag/v0.1.0), 4 days ago) - ✅ A better Pre-Commit hook to check your Shell scripts
