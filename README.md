...
- [Jarmos-san/dev-workflow](https://github.com/Jarmos-san/dev-workflow) - A repo documenting my personal development workflow which will then served &amp; distributed over the Internet with GitBook (1 day ago)
...
- [tiangolo/fastapi](https://github.com/tiangolo/fastapi) ([0.73.0](https://github.com/tiangolo/fastapi/releases/tag/0.73.0), 1 week ago) - FastAPI framework, high performance, easy to learn, fast to code, ready for production
