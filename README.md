...
- [Jarmos-san/jefer](https://github.com/Jarmos-san/jefer) ([v0.1.0](https://github.com/Jarmos-san/jefer/releases/tag/v0.1.0), today) - A simple, intuitive &amp; minimal dotfiles manager written in Python.
